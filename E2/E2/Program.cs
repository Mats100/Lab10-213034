namespace E2
{
    public class StudentClass
    {
        ...
        protected static List<Student> students = new List<Student>
        {
            ...
            new Student {FirstName = "Clarie", LastName = "O'Donell", ID = 112, Year = GradeLevel.FourthYear, ExamScores = new List<int> {75, 84, 91, 39}},
            ...
            new Student {FirstName = "Sven", LastName = "Mortenson", ID = 113, Year = GradeLevel.FirstYear, ExamScores = new List<int> {88, 94, 65, 91}},
           };
